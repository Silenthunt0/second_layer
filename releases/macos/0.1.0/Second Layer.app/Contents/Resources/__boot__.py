...
_site_packages('/Volumes/ExtremePro/dev/personal/second_layer/venv', '/opt/homebrew/opt/python@3.13', 0)
...
_path_inject(['/Volumes/ExtremePro/dev/personal/second_layer'])
...
DEFAULT_SCRIPT='/Volumes/ExtremePro/dev/personal/second_layer/main.py'
SCRIPT_MAP={}
try:
    _run()
